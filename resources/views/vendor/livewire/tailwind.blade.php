...
? "(document.querySelector('{$scrollTo}') || document.body).scrollIntoView();"
: '';
@endphp
<div>
                ...
                <span class="relative z-0 inline-flex rtl:flex-row-reverse rounded-md shadow-sm">
                    <span>
                        ...
                        <button type="button" wire:click="previousPage('{{ $paginator->getPageName() }}')"
                            ...
                            class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-l-md leading-5 hover:text-gray-400 focus:z-10 focus:outline-none focus:border-blue-300 focus:ring ring-blue-300 active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150"
                    ...
                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                        ...
                        <span aria-current="page">
                            ...
                            <span
                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium bg-red text-white border border-gray-300 cursor-default leading-5">{{
                                $page }}</span>
                        </span>
                        @else
                        <button type="button" wire:click="gotoPage({{ $page }}, '{{ $paginator->getPageName() }}')"
                            x-on:click="{{ $scrollIntoViewJsSnippet }}"
                            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:ring ring-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
